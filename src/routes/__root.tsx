...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "مشوارك علينا ليموزين الفيوم" },
      { name: "description", content: "خدمة ليموزين وسفر VIP من وإلى الفيوم وجميع محافظات مصر على مدار 24 ساعة." },
      { name: "author", content: "مشوارك علينا ليموزين الفيوم" },
      { property: "og:site_name", content: "مشوارك علينا ليموزين الفيوم" },
      { property: "og:title", content: "مشوارك علينا ليموزين الفيوم" },
